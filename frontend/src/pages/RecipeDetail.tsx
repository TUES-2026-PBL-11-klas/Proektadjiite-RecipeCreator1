      ...
      <div className="page-wrapper">
        <EmptyState
          ...
          action={
            <Link
              to="/recipes"
              className="inline-flex items-center gap-1.5 px-4 py-2 bg-primary text-primary-foreground text-sm font-semibold rounded-lg no-underline hover:bg-primary/90 transition-colors"
            >
              Back to Recipes
            </Link>
          }
        ...
        <div className="space-y-5">
          {recipe.ingredients && recipe.ingredients.length > 0 && (
            <div className="bg-card border border-border rounded-xl shadow-sm p-5">
              <h2 className="text-base font-semibold text-foreground font-serif mb-4">
                Ingredients
              </h2>
