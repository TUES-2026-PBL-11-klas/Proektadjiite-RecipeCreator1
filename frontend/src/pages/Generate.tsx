...
const Generate = () => {
  ...
  const handleGenerate = async () => {
    if (pantry.length === 0) {
      setError("Add items to your pantry first.");
      return;
    }
    setGenerating(true);
    setResult(null);
        ...
        <div className="space-y-4">
          ...
          <div className="bg-card border border-border rounded-xl shadow-sm p-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                {
                  id: "pantry-only" as GenerateMode,
                  icon: ShoppingBasket,
                  label: "Pantry Only",
                  desc: "Uses only what you have",
                },
                {
                  id: "ai-enhanced" as GenerateMode,
                  icon: Zap,
                  label: "AI Enhanced",
                  desc: "May suggest extra ingredients",
                },
              ...
              <div className="bg-card border border-border rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap items-center gap-2 mb-5">
                    ...
                    <span
                      className={
                        diffBadge[result.difficulty_level] ?? "badge-easy"
                      }
                    >
